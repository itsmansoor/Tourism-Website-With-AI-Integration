      ...
      <div className="w-full flex flex-col">
        ...
        <div className="backaground_image w-full flex flex-col">
          ...
          <p className="hidden lg:block text-white text-lg max-w-md mt-3 ml-4">
            Explore top-rated destinations, discover the best travel offers,
            and stay updated with the latest trips.
          </p>
        </div>
        ...
        <div className="top-part w-full mx-auto gap-2 flex flex-col items-center justify-center">
          ...
          <h2 className="text-white text-sm text-center xsm:text-lg font-semibold">
          ...
          <div className="w-full flex justify-center items-center gap-2 mt-8">
            ...
            <button
              ...
              className="bg-white w-10 h-10 flex justify-center items-center text-xl font-semibold rounded-full hover:scale-95 transition"
            >
              Go
            </button>
          </div>
          ...
          <div className="w-[90%] max-w-xl flex justify-center mt-10">
            <button
              ...
              className="flex items-center justify-around gap-1 bg-slate-400 text-white p-2 py-1 text-[8px] xxsm:text-sm sm:text-lg border-e border-white rounded-s-full flex-1 hover:scale-105 transition-all duration-150"
            >
              Special Offers
            ...
            <button
              ...
              className="flex items-center justify-around gap-1 bg-slate-400 text-white p-2 py-1 text-[8px] xxsm:text-sm sm:text-lg border-x border-white flex-1 hover:scale-105 transition-all duration-150"
            >
              Top Rated
            ...
            <button
              ...
              className="flex items-center justify-around gap-1 bg-slate-400 text-white p-2 py-1 text-[8px] xxsm:text-sm sm:text-lg border-s border-white rounded-e-full flex-1 hover:scale-105 transition-all duration-150"
            >
              Most Rated
